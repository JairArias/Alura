document.addEventListener("DOMContentLoaded", () => {
  ...
  const encriptacionOutput = document.querySelector(
    ".body__main__sidebar__encriptacion"
  );
  ...
  document
    .querySelector(".body__main__section__btns__btn1")
    .addEventListener("click", encriptar);
  document
    .querySelector(".body__main__section__btns__btn2")
    .addEventListener("click", desencriptar);
  document
    .querySelector(".body__main__section__btns__btn3")
    .addEventListener("click", copiarTexto);
});

function encriptarFrase() {}

function textoChallenger(elemento, informacion) {
  let elementoHTML = document.querySelector(elemento);
  elementoHTML.innerHTML = informacion;
}
...
textoChallenger("h1", "Bienvenido a nuestro encriptador de texto");
textoChallenger(body__main__sidebar__aviso, "Hola");
